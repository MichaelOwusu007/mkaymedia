  ...
  return (
    <footer className="relative overflow-hidden bg-foreground text-background">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-foreground z-10 mask-[radial-gradient(transparent,white)] pointer-events-none" />
      ...
      <div className="relative z-20">
        {/* CTA Strip */}
        <div className="bg-muted/90 backdrop-blur py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            >
              ...
              <p className="text-background/70 text-sm leading-relaxed">
                Your creative partner for stunning graphic design and
                high-quality printing solutions. We bring your vision to life.
              </p>
            ...
            >
              <h4 className="font-heading font-semibold text-lg mb-6 text-background">
                Quick Links
              </h4>
<ul className="space-y-3">
  {quickLinks.map((link, index) => (
    ...
    >
      <Link
        href={link.href}
        className="inline-flex w-fit items-center gap-2 text-background/70 hover:text-background transition-colors group"
      >
        <ArrowRight
          size={14}
        ...
        {link.label}
          ...
          >
            <p className="text-background/60 text-sm">
              © {new Date().getFullYear()} Kryptic Pixel Studio. All rights
              reserved.
            </p>
            <p className="text-background/60 text-sm">
